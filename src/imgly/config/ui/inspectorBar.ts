 ...
 * Different edit modes show different controls optimized for the editing context.
 *
 * ## Edit Modes
 *
...
export function setupInspectorBar(cesdk: CreativeEditorSDK): void {
  ...
  // Full editing controls for selected overlays (text, shapes, stickers)
  // ============================================================================
  ...
  // Controls for cropping the photo (flip, rotate, reset)
  // ============================================================================
