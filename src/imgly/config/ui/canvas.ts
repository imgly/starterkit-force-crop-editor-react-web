 ...
 * ## Edit Modes
 *
 * - `'Transform'`: Default mode for selecting and moving overlays (text, shapes, stickers)
 * - `'Text'`: Text editing mode (when editing text content)
 * - `'Crop'`: Crop mode (when cropping the photo)
 * - `'Trim'`: Trim mode (when trimming video/audio - not typical in photo editor)
 *
 * ## Canvas Bar Position
 *
 * The canvas bar can be positioned at `'top'` or `'bottom'` of the canvas.
 * For photo editing, `'bottom'` position is recommended to avoid blocking the image.
 *
...
export function setupCanvas(cesdk: CreativeEditorSDK): void {
  // ============================================================================
  // CANVAS BAR
  // Configure the bar at the bottom of the canvas
  // ============================================================================
  ...
  // Context menu when overlays (text, shapes, stickers) are selected
  // ============================================================================
  ...
  // Context menu when editing vector paths (empty - no context actions needed)
  // ============================================================================
